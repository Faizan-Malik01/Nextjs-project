      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-bold text-slate-800 mb-4">
            Why Invest In Our <span className="relative inline-block px-2">
              <span className="relative z-10 text-[#2fb383]">Coding</span>
              <span className="absolute inset-0 bg-[#dcfce7] rounded-md -rotate-1"></span>
            </span> Education <br className="hidden md:block" /> And Project Services?
          </h2>
